    ...
    'intro',
    {
      ...
      items: [ 
        ...
        'remote-docs/clarinet/getting-started',
        {
          ...
          items: [
            'remote-docs/clarinet/feature-guides/analyze-with-check-checker',
            'remote-docs/clarinet/feature-guides/extend-clarinet',
          ],
        },
        {
          type: 'category',
          label: 'How-to Guides',
          items: [
            'remote-docs/clarinet/how-to-guides/how-to-set-up-local-development-environment',
            'remote-docs/clarinet/how-to-guides/how-to-create-new-project',
            'remote-docs/clarinet/how-to-guides/how-to-add-contract',
            'remote-docs/clarinet/how-to-guides/how-to-check-contract',
            'remote-docs/clarinet/how-to-guides/how-to-test-contract',
            'remote-docs/clarinet/how-to-guides/how-to-debug-contract',
            'remote-docs/clarinet/how-to-guides/how-to-deploy-contracts',
            'remote-docs/clarinet/how-to-guides/how-to-run-integration-environment',
            'remote-docs/clarinet/how-to-guides/how-to-deploy-with-subnets',
          ],
        },
        //'clarinet/troubleshooting',
        'remote-docs/clarinet/faq',
        {
          type: 'category',
